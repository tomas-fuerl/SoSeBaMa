...
| SEC-004 | Positive Rechte müssen additiv ausgewertet werden; negative Rechte sind unzulässig. Globale Aktionsrechte dürfen nur direkt aktiven Benutzern oder globalen Gruppen zugewiesen werden. Bands und bandbezogene Gruppen dürfen ausschließlich bandbezogene Rechte und Objektberechtigungen tragen. Nur Plattformadministratoren verwalten globale Rechte und global rechtevermittelnde Gruppenmitgliedschaften. | Bandadministration kann durch Bandgruppenänderung keine globalen Rechte erteilen oder entziehen; Implikationen allgemeiner Rechte bleiben exakt begrenzt. |
