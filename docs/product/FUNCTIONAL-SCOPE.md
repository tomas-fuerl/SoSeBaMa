...
| --- | --- | --- |
| FR-001 | SoSeBaMa muss mehrere Benutzer, mehrere Bands, globale und bandbezogene Gruppen sowie mehrere getrennte Bandbereiche unterstützen. Das globale Benutzerkonto und jede Bandmitgliedschaft müssen getrennte Zustände besitzen. Nur Plattformadministratoren dürfen Konten manuell aktivieren, deaktivieren oder löschen; die automatische normale Kontoaktivierung nach gültiger Einladungsannahme gemäß `FR-071` ist ein Systemworkflow und keine manuelle Befugnis des Einladenden. Bandberechtigte verwalten ausschließlich Mitgliedschaften ihrer eigenen Band. Benutzer dürfen mehreren Bands und Gruppen angehören. | Manuelle Aktivierung, Deaktivierung und Löschung ausschließlich durch Plattformadministratoren sowie die systemgesteuerte Aktivierung ausschließlich nach erfolgreicher Annahme einer gültigen Einladung werden getrennt geprüft; systemgesteuerte Deaktivierung oder Löschung ist damit nicht verbunden. Einladung, Aktivierung, Deaktivierung und Entfernung einer Bandmitgliedschaft werden davon getrennt geprüft; andere Bands bleiben unverändert. |
