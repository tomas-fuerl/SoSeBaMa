...
| --- | --- | --- |
| FR-001 | SoSeBaMa muss mehrere Benutzer, mehrere Bands, globale und bandbezogene Gruppen sowie mehrere getrennte Bandbereiche unterstützen. Das globale Benutzerkonto und jede Bandmitgliedschaft müssen getrennte Zustände besitzen. Nur Plattformadministratoren dürfen Konten aktivieren, deaktivieren oder löschen; Bandberechtigte verwalten ausschließlich Mitgliedschaften ihrer eigenen Band. Benutzer dürfen mehreren Bands und Gruppen angehören. | Kontoaktivierung, -deaktivierung und -löschung sowie Einladung, Aktivierung, Deaktivierung und Entfernung einer Bandmitgliedschaft werden getrennt geprüft; andere Bands bleiben unverändert. |
...
| FR-035 | Eigene, nur durch einen Benutzer beschreibbare Inhalte, Overlays und Setlists sowie persönliche Setlisteinstellungen müssen offline bearbeitbar sein. Offline neu angelegte Inhalte müssen ohne Freigaben bleiben; bei Synchronisation werden Pflichtfelder und normalisierte Zuordnung gegen alle Songs geprüft, ohne unsichtbare Beziehungen offenzulegen. Neu erteilte Rechte dürfen keinen automatischen Download auslösen. | Nicht synchronisierte Entwürfe bleiben bei Fehler erhalten; Zuordnung oder Neuanlage und bewusste Offlinevorbereitung sind erkennbar. |
...
| FR-066 | Jedes gemeinsam bearbeitbare Objekt außer Songs muss einen sitzungsgebundenen Check-out mit global konfigurierbarer Online-Lease verwenden. Inhalt, Overlay und Setlist werden getrennt gesperrt; der Inhalts-Check-out umfasst Basisinhalt/PDF und alle Inhaltsmetadaten, aber kein eigenständiges Overlay und keine atomar geprüfte administrative Aktion. Die Sitzung muss vor Ablauf gewarnt werden. Nach Ablauf, Netzwerkverlust oder Rücknahme darf sie weder still speichern noch still neu reservieren; Wiederverbindung prüft Check-out-Kennung, Sitzung, Lease, Rechte, Revision beziehungsweise Serverstand und Löschstatus. Leser sehen nur den gespeicherten Stand. Eigene Mehrfachsitzungen und dynamische Übergänge folgen dem Referenzmodell. |
